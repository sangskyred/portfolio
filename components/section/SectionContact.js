...
const SectionContact = () => {
    let listInfor = [
        {
            icon: (<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
                ...
                <div className="col-8 form">
                    <form autoComplete="off">
                        <div className="form-group">
                            ...
                            <div className="col-6">
                                <input type="email" placeholder="Your Email" maxLength={50} required />
                            </div>
                        </div>
